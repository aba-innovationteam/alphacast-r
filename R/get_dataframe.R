...
#' @param alphacast_api_key API Key from Alphacast. You can get it from your Settings menu on the Alphacast.io Web.
#' @param long Logical. Choose between data format.
#' @return A data.frame with dates, entity and data.
#' @examples
